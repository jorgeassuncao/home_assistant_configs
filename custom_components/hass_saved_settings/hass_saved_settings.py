...
BEGIN CUSTOMIZE
"""
path = "/config/custom_components/hass_saved_settings" # Path to ini file. ex. "/home/mike/.homeassistant/saved_input_settings.ini"
host = "universe-network.ddns.net:6523" # Host & Port of Home-Assistant. ex. "localhost:8123"
api_key = "2105" # Frontend / API Info. ex. "MyHassPassword"
